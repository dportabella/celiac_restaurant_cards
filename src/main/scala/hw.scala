object Hi {
  def main(args: Array[String]) = {
    println("Hi!")
//    val content = scala.xml.XML.load(getClass.getResourceAsStream("english.xml"))
    val content = scala.xml.XML.load(getClass.getResourceAsStream("turkish.xml"))

    val language = "turkish"

    case class Parameter(font: String = "Arial", titleSize: String, size: String, titleSpace: String, space: String, thanksSpace: String, lastSpace: String)

    val parametersMap = Map(
      "language" -> Parameter(font="Arial", titleSize="9pt", size="7.5pt", titleSpace="0.20cm", space="0.20cm", thanksSpace="0.38cm", lastSpace="0.1cm"),
      "turkish"  -> Parameter(font="Arial", titleSize="9pt", size="7.0pt", titleSpace="0.20cm", space="0.15cm", thanksSpace="0.38cm", lastSpace="0.1cm"),
      "japanese" -> Parameter(font="MS Mincho", titleSize="8pt", size="6.7pt", titleSpace="0.20cm", space="0.20cm", thanksSpace="0.38cm", lastSpace="0.1cm")
    )
